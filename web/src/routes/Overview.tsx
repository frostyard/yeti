    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          ...
          {d.counts.queueBlockedByTier > 0 && (
            <StatCard label="Tier-Blocked" value={d.counts.queueBlockedByTier} tone="warning" sub="queued items gated by autonomy" icon={<ShieldAlert size={15} />} />
          )}
        </div>
      </section>
